...
it('generate ' + GENERATOR_NAME.toUpperCase(), async () => {
  ...
  let opts = {
    output_filepath: path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.basic.generated_output'
    ),
...
it('generate empty ' + GENERATOR_NAME.toUpperCase(), async () => {
  ...
  let opts = {
    output_filepath: path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.empty.generated_output'
    ),
    generator: GENERATOR_NAME,
    filter: () => {
      return true
  ...
  let inputCss = fs.readFileSync(
    path.resolve(__dirname, '../input_data/empty_input_data.css'),
    'utf8'
  )
  ...
  let expectedCode = fs.readFileSync(
    path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.empty.expected_output'
    ),
    'utf8'
  )
  expect(eol.auto(generatedCode)).toEqual(eol.auto(expectedCode))
...
it('generate number ' + GENERATOR_NAME.toUpperCase(), async () => {
  ...
  let opts = {
    output_filepath: path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.number.generated_output'
    ),
    generator: GENERATOR_NAME,
    filter: () => {
      return true
  ...
  let inputCss = fs.readFileSync(
    path.resolve(__dirname, '../input_data/number_input_data.css'),
    'utf8'
  )
  ...
  let expectedCode = fs.readFileSync(
    path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.number.expected_output'
    ),
    'utf8'
  )
  expect(eol.auto(generatedCode)).toEqual(eol.auto(expectedCode))
...
it('generate custom ' + GENERATOR_NAME.toUpperCase(), async () => {
  // GIVEN
  let opts = {
    output_filepath: path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.custom.generated_output'
    ),
    generator: GENERATOR_NAME,
    filter: () => {
      return true
  ...
  let inputCss = fs.readFileSync(
    path.resolve(__dirname, '../input_data/custom_input_data.css'),
    'utf8'
  )
  ...
  let expectedCode = fs.readFileSync(
    path.resolve(
      __dirname,
      GENERATOR_NAME + '_generator.custom.expected_output'
    ),
    'utf8'
  )
  expect(eol.auto(generatedCode)).toEqual(eol.auto(expectedCode))
